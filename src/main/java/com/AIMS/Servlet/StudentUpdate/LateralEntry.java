...
/**
 * Servlet implementation class LateralEntry
 */
public class LateralEntry extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int status = DatabaseConnectivity.updateLateralEntry(lateralEntry, rollno);
		if (status > 0) {

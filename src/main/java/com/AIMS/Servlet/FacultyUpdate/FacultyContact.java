...
/**
 * Servlet implementation class FacultyContact
 */
public class FacultyContact extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int status = DatabaseConnectivity.facultyContact(contact, aicteid);
		if (status > 0) {

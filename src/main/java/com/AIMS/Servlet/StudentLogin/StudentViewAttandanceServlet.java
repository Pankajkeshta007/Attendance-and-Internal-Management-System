...
/**
 * Servlet implementation class StudentViewAttandanceServlet
 */
public class StudentViewAttandanceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentViewAttandanceServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    boolean status=DatabaseConnectivity.studentValidate1(student_id);
	    if(status)
	    {

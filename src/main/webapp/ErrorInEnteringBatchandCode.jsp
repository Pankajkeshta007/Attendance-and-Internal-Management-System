...
<html>
<head>
    <title>Enter Correct Subject Code or Student Roll number</title>
...
<div id="messageContainer" class="message-container" style="display: none;">
    <div class="message-box">
        <p>Enter Correct Subject Code or Student Roll number</p>
...
<script type="text/javascript">
    ...
    function navigateToAnotherPage() {
        window.location.href = 'Add_Internal.jsp'; // Replace 'anotherPage.jsp' with the actual page you want to navigate to
    }
</script>

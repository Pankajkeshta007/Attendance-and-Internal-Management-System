...
%>
	<div class="container">
		...
		<form action ="FatherName" method="post">
			<label for="rollno"> Father's Name:</label> <input type="text"
				id="rollno" name="fathername" placeholder="Enter new father name of student " required><br>
			<br>

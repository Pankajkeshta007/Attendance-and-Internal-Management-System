...
%>
	<div class="container">
		...
		<form action ="Percentage12" method="post">
			<label for="rollno"> 12th Percentage:</label> <input type="text"
				id="rollno" name="percentage" placeholder="Enter new percentage of student " required><br>
			<br>

...
<nav> 
    ...
    <form action="SelectBCode_Add_Internal" method="POST">
        <!-- Headings for the form -->
        <div class="headingsContainer">
            <h2>Add Student internal</h2>
        ...
        <div class="mainContainer">
            <!-- Username -->
            <label for="subject_id">Enter Subject Code</label>
            <input type="text" placeholder="e.g. cs-701" name="subject_id" required>

            <br>
             <label for="student_id"> Enter student University ROll number</label>
             <input type="text" placeholder="student roll number" name="student_id" required>
             <br><br>

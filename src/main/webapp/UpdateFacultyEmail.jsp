...
%>
	<div class="container">
		...
		<form action ="FacultyEmail" method="post">
			<label for="rollno"> Email:</label> <input type="email"
				id="rollno" name="email" placeholder="Enter new email of faculty " required><br>
			<br>

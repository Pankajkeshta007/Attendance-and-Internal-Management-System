...
<div id="messageContainer" class="message-container" style="display: none;">
    <div class="message-box">
        <p>Please Enter Correct Subject Code </p>
...
<script type="text/javascript">
    ...
    function navigateToAnotherPage() {
        window.location.href = 'Student_Code_select2.jsp'; // Replace 'anotherPage.jsp' with the actual page you want to navigate to
    }
</script>

...
<%
String facAicteid=session.getAttribute("aicteid").toString();
session.setAttribute("facultyAicteid", facAicteid);
%>
	<div class="container">
		<h2>Faculty Update Menu</h2>
		<form action ="FacultyContact" method="post">
			<label for="rollno"> Contact :</label> <input type="text"
				id="rollno" name="contact" placeholder="Enter new contact no. of faculty " required><br>
			<br>
			<div class="btn-container">
				<a href="SelectFacultyFieldForUpdate.jsp">Back</a>

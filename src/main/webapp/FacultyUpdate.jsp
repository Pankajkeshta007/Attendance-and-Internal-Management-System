...
<header>
	...
	<div class="container">
		<h2>FACULTY UPDATE SECTION</h2>
		<form method="post" action="FacultyUpdateServlet">
			<label for="rollno">Aicte ID :</label> <input type="text"
				id="rollno" name="aicteid" placeholder="enter aicte id " required><br>
			<br>

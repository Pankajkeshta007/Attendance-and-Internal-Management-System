...
%>
	<div class="container">
		...
		<form action ="FacultyPassword" method="post">
			<label for="rollno"> Password:</label> <input type="password"
				id="rollno" name="password" placeholder="Enter new password " required><br>
			<br>

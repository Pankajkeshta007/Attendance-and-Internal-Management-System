...
%>
	<div class="container">
		...
		<b><form action ="CourseOutcome" method="post">
			<label for="subjectname"> Course Outcome :</label> <input type="text"
				id="coa" name="coa" placeholder="Enter new COA " required><br>
			<br>
			<div class="btn-container">
				<a href="SelectSubjectFieldForUpdate.jsp">Back</a>
